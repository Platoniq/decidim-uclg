...
checksums = [
  {
    ...
    files: {
      "/app/controllers/decidim/admin/concerns/has_private_users.rb" => "3db7f6a3e8ba1f616122c89f2c9510f8",
    ...
    files: {
      "/app/views/decidim/conferences/conference_program/show.html.erb" => "3ac67685fe8a8f7efcce0416461e4277",
