...
class AddActiveFlagToStep < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :decidim_participatory_process_steps, %i[decidim_participatory_process_id active], unique: true, where: "active = 't'", name: 'unique_index_to_avoid_duplicate_active_steps'
  end
end
