...
ActiveRecord::Schema.define(version: 20_200_519_105_848) do
  ...
  create_table 'decidim_accountability_results', id: :serial, force: :cascade do |t|
    ...
    t.index %w[decidim_component_id external_id], name: 'decidim_accountability_results_on_external_id', unique: true
